...
- Create Angular project with ng: `ng new mirtechtestovoe.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`mirtechtestovoe.client.esproj`).
